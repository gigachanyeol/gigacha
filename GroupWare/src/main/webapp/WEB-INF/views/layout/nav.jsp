                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="./approval">기안 작성</a></li>
                            <li><a class="dropdown-item" href="./approval">결재목록</a></li>
                            <li><a class="dropdown-item" href="./approval">나의 결재함</a></li>
                            <li><a class="dropdown-item" href="./approval/approvalForm.do">문서양식관리(관리자)</a></li>
                        </ul>
                    </li>
