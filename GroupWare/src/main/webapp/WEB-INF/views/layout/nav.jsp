                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/approvalRequestList.do">결재목록</a></li>
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/approvalList.do">결재요청함</a></li>
